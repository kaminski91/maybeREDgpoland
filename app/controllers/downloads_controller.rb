class DownloadsController < ApplicationController
  ...
  def index
    if user_signed_in?
      @downloads = current_user.downloads.all.order(:created_at)
    else
  ...
  def create
    ...
    respond_to do |format|
      if @download.save
        format.html { redirect_to admin_path, notice: 'Download was successfully created.' }
  ...
  private
    ...
    def download_params
      params.require(:download).permit(:user_id, :file)
    end
end
