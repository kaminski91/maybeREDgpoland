...
class SalonsControllerTest < ActionController::TestCase
  ...
  test "should create salon" do
    assert_difference('Salon.count') do
      post :create, salon: { address: @salon.address, brand: @salon.brand, city: @salon.city, coutry: @salon.coutry, description: @salon.description, posX: @salon.posX, posY: @salon.posY }
    end
  ...
  test "should update salon" do
    patch :update, id: @salon, salon: { address: @salon.address, brand: @salon.brand, city: @salon.city, coutry: @salon.coutry, description: @salon.description, posX: @salon.posX, posY: @salon.posY }
    assert_redirected_to salon_path(assigns(:salon))
  end
